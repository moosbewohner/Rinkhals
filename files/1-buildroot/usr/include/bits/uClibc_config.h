...
#define __KERNEL_HEADERS__ "/buildroot/output/build/linux-headers-6.1.57/usr/include"
...
#define __CROSS_COMPILER_PREFIX__ "/buildroot/output/host/bin/arm-buildroot-linux-uclibcgnueabihf-"
