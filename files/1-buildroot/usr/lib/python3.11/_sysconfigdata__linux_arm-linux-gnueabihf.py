...
build_time_vars = {'ABIFLAGS': '',
 ...
 'ALT_SOABI': 0,
 'ANDROID_API_LEVEL': 0,
 'AR': '/buildroot/output/host/bin/arm-buildroot-linux-uclibcgnueabihf-gcc-ar',
 'ARFLAGS': 'rcs',
 ...
 'BLDSHARED': '/buildroot/output/host/bin/arm-buildroot-linux-uclibcgnueabihf-gcc '
              '-shared',
 'BOOTSTRAP_HEADERS': '\\',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'BYTESTR_DEPS': '\\',
 'CC': '/buildroot/output/host/bin/arm-buildroot-linux-uclibcgnueabihf-gcc',
 'CCSHARED': '-fPIC',
 ...
 'CONFIG_ARGS': "'--target=arm-buildroot-linux-uclibcgnueabihf' "
                ...
                "'--with-expat=system' "
                "'--with-openssl=/buildroot/output/host/arm-buildroot-linux-uclibcgnueabihf/sysroot/usr' "
                "'--disable-codecs-cjk' '--disable-uuid' '--disable-bzip2' "
                "'--disable-ossaudiodev' '--without-ensurepip' "
                "'--without-cxx-main' "
                "'--with-build-python=/buildroot/output/host/bin/python3' "
                ...
                "-D_FILE_OFFSET_BITS=64  -Os -g0 ' 'LDFLAGS=' "
                "'CPPFLAGS=-D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE "
                "-D_FILE_OFFSET_BITS=64' "
                "'CPP=/buildroot/output/host/bin/arm-buildroot-linux-uclibcgnueabihf-cpp'",
 'CONFINCLUDEDIR': '/usr/include',
 'CONFINCLUDEPY': '/usr/include/python3.11',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/buildroot/output/build/python3-3.11.6/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/buildroot/output/build/python3-3.11.6/lcov-report',
 ...
 'CPPFLAGS': '-I. -I./Include -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE '
             '-D_FILE_OFFSET_BITS=64',
 'CXX': '/buildroot/output/host/bin/arm-buildroot-linux-uclibcgnueabihf-g++',
 ...
 'FREEZE_MODULE': '/buildroot/output/host/bin/python3 '
                  './Programs/_freeze_module.py',
 'FREEZE_MODULE_BOOTSTRAP': '/buildroot/output/host/bin/python3 '
                            './Programs/_freeze_module.py',
 ...
 'HAVE__GETPTY': 0,
 'HOSTRUNNER': '',
 'HOST_GNU_TYPE': 'arm-buildroot-linux-uclibcgnueabihf',
 ...
 'IO_OBJS': '\\',
 'LDCXXSHARED': '/buildroot/output/host/bin/arm-buildroot-linux-uclibcgnueabihf-g++ '
                '-shared',
 'LDFLAGS': '',
 'LDFLAGS_NODIST': '',
 'LDLIBRARY': 'libpython3.11.so',
 'LDLIBRARYDIR': '',
 'LDSHARED': '/buildroot/output/host/bin/arm-buildroot-linux-uclibcgnueabihf-gcc '
             '-shared',
 'LDVERSION': '3.11',
 'LIBC': '',
 ...
 'LIBS': '-lintl -ldl  -lpthread',
 'LIBSUBDIRS': 'asyncio \\',
 'LINKCC': '/buildroot/output/host/bin/arm-buildroot-linux-uclibcgnueabihf-gcc',
 ...
 'MAINCC': '/buildroot/output/host/bin/arm-buildroot-linux-uclibcgnueabihf-gcc',
 'MAJOR_IN_MKDEV': 0,
 ...
 'MODULE_BINASCII_LDFLAGS': '-L/buildroot/output/host/bin/../arm-buildroot-linux-uclibcgnueabihf/sysroot/usr/lib '
                            '-lz',
 ...
 'MODULE_ZLIB_CFLAGS': '',
 'MODULE_ZLIB_LDFLAGS': '-L/buildroot/output/host/bin/../arm-buildroot-linux-uclibcgnueabihf/sysroot/usr/lib '
                        '-lz',
 ...
 'MODULE__HASHLIB_CFLAGS': '-I/buildroot/output/host/arm-buildroot-linux-uclibcgnueabihf/sysroot/usr/include',
 'MODULE__HASHLIB_DEPS': './Modules/hashlib.h',
 'MODULE__HASHLIB_LDFLAGS': '-L/buildroot/output/host/arm-buildroot-linux-uclibcgnueabihf/sysroot/usr/lib   '
                            '-lcrypto',
 ...
 'MODULE__LZMA_CFLAGS': '',
 'MODULE__LZMA_LDFLAGS': '-L/buildroot/output/host/bin/../arm-buildroot-linux-uclibcgnueabihf/sysroot/usr/lib '
                         '-llzma',
 ...
 'MODULE__SQLITE3_LDFLAGS': '-L/buildroot/output/host/bin/../arm-buildroot-linux-uclibcgnueabihf/sysroot/usr/lib '
                            '-lsqlite3',
 'MODULE__SQLITE3_STATE': 'yes',
 'MODULE__SRE_LDFLAGS': '',
 'MODULE__SSL_CFLAGS': '-I/buildroot/output/host/arm-buildroot-linux-uclibcgnueabihf/sysroot/usr/include',
 ...
 'MODULE__SSL_LDFLAGS': '-L/buildroot/output/host/arm-buildroot-linux-uclibcgnueabihf/sysroot/usr/lib  '
                        '-lssl -lcrypto',
 ...
 'MODULE__UUID_CFLAGS': '-I/buildroot/output/host/bin/../arm-buildroot-linux-uclibcgnueabihf/sysroot/usr/include/uuid',
 'MODULE__UUID_LDFLAGS': '-L/buildroot/output/host/bin/../arm-buildroot-linux-uclibcgnueabihf/sysroot/usr/lib '
                         '-luuid',
 ...
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-I/buildroot/output/host/arm-buildroot-linux-uclibcgnueabihf/sysroot/usr/include',
 'OPENSSL_LDFLAGS': '-L/buildroot/output/host/arm-buildroot-linux-uclibcgnueabihf/sysroot/usr/lib',
 ...
 'PYTHONPATH': '',
 'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/buildroot/output/build/python3-3.11.6 '
                     '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
                     'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
                     '/buildroot/output/build/python3-3.11.6/`cat '
                     'pybuilddir.txt`:)./Lib '
 ...
 'PYTHON_FOR_FREEZE': '/buildroot/output/host/bin/python3',
 'PYTHON_FOR_REGEN': '',
 'PYTHON_HEADERS': '\\',
 'PYTHON_OBJS': '\\',
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-Wsign-compare -DNDEBUG -g  -O3 -Wall '
                             '-D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE '
                             '-D_FILE_OFFSET_BITS=64  -Os -g0 -std=c11 -Wextra '
 ...
 'READELF': '/buildroot/output/host/bin/arm-buildroot-linux-uclibcgnueabihf-readelf',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': '_PYTHON_PROJECT_BASE=/buildroot/output/build/python3-3.11.6 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
               '/buildroot/output/build/python3-3.11.6/`cat '
               'pybuilddir.txt`:)./Lib '
               ...
               '/buildroot/output/host/bin/python3',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': '_PYTHON_PROJECT_BASE=/buildroot/output/build/python3-3.11.6 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
               '/buildroot/output/build/python3-3.11.6/`cat '
               'pybuilddir.txt`:)./Lib '
 ...
 'abs_builddir': '/buildroot/output/build/python3-3.11.6',
 'abs_srcdir': '/buildroot/output/build/python3-3.11.6',
